\# Contributing to ScoutHub

Contributions to ScoutHub are welcome!



ScoutHub is a self-hosted tool for managing Scout Groups.
...
There are several ways to contribute to ScoutHub:
...
\- Use the provided test framework to write tests
...
By contributing to ScoutHub, you agree that your contributions will be licensed under the MIT License.
